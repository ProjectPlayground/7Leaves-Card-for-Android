...
public class FreeStampService extends Service {
    ...
    private Notification oneSenderNotification() {
        ...
        return new NotificationCompat.Builder(getApplicationContext())
                ...
                .setContentTitle("You just received a free stamp!")
                .setContentText("Because you have staid with us the past year we are awarding you with a free stamp.")
                .build();
    }
}
